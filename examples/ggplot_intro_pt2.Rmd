...
A list of color names available in R can be found [here](http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf)
...
The vertical reference line is positioned at the average price. See `?vline` for help on how to add it.
