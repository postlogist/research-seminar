---
title: "Exploratory data analysis for alcohol consumption by secondary school students"
...
Put your code to load libraries and the data in the following code chunk. You'll need `ggplot2`, `scales`, `dplyr` and `readxl` packages for this assignment. Use `read_excel()` to read-in the data file.
